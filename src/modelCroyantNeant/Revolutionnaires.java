...
public class Revolutionnaires extends Croyant {
	...
	public Revolutionnaires() {
		super();
		this.setNomCroyant("Revolutionnaires");
		this.setOrigine("Neant");
		this.setDogmes(dogemes);
		this.setDescription("Impose le sacrifice d'un Croyant d'un autre joueur,"
				+ " qui choisit la carte. "
				+ "La capacit� sp閏iale du sacrifice est jou閑.");
		this.setNbPriere(2);
		Image image = null;
		try {
			image = ImageIO.read(new File ("revolutionnaires.jpg"));
