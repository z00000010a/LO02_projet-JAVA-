...
public class Moines1 extends Croyant {
	...
	public Moines1() {
		...
		this.setNomCroyant("Moines");
		this.setOrigine("Jour");
		this.setDogmes(dogemes);
		this.setDescription("Donne un point d'Action d'Origine Jour.");
		this.setNbPriere(2);
		Image image = null;
		try {
			image = ImageIO.read(new File ("moines1.jpg"));
	...
	public void sacrifier(int numJ){
		...
		Partie.getJoueurHumain().setPointActionJour(Partie.getJoueurHumain().getPointActionJour()+1);
