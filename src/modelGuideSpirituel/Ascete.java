...
{	private static Joueur JoueurQuiJoueLaCarte; 
	String description = "Sacrifie 2 cartes Croyants d'une Divinitï¿½ ayant le Dogme Humain ou Symboles. Les capacité–Ÿ spé–�iales sont joué–‘s normalement.";
	/**
	...
	public Ascete ()
	{
		...
		Image image = null;
		try {
			image = ImageIO.read(new File ("ascete.jpg"));
