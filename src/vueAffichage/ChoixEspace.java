 ...
 * Elle les stock dans un JTabbedPane, ce qui permet de naviguer entre ces vues avec simplicit�. Elle est impl閙ent� 
...
{	/**
	* Un attribut contenant les joueur, utilis� pour cr閑r afficher les VueEspace qui sont contenu dans ces joueurs
	* 
	*/
	...
	/**
	 * Ce constructeur va cr閑r la fen鑤re principale et appeler la m閠hode initier avec comme arguments toutes
	 * les vues des espaces de chaque joueur de la partie.
	 * @param tabJ Les joueur dont on va r閏up閞er l'attribut EspaceJoueur
	...
	/**
	 * La m閠hode pour obtenir l'instance
	...
	/**
	 * Cette m閠hode va remplir la fenetre cr閑r par le constructeur. Elle va stocker ces VueEspace dans un JTabbedPane
	...
	public void initier(VueEspaceCentral vueEspaceCentral, VueEspace [] tabEspaceJ)
	{
		...
		onglets.addTab("Vos donnés", ((JoueurPhysique) j).getVueStatJoueur());
	...
	/**
	 * Un m閠hode qui va 阾re appel� par les VueEspace lorsqu'ils auront besoin de se mettre � jour. Automatiquement
	 * appel閑 par la m閠hode update de ces derniers.
