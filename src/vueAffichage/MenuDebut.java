...
/**
 * Une classe qui permet de d閙arrer le jeu sur une image et 3 boutons. C'est elle qui contient la 
 * m閠hode main n閏essaire au lancement du programme.
 */
public class MenuDebut extends JFrame
{
	 ...
	 * Un permettant de lancer le jeu � proprement parler et les deux autres ouvrant un lien respectivement vers les 
	 * r鑗les et vers le site web du cr閍teur du jeu.
	 */
	public MenuDebut()
	{
		super("Pandocrean Divinae : le jeu des luttes divines");
		Dimension dim = Toolkit.getDefaultToolkit().getScreenSize();
		this.setSize(dim);//donne les dim de l'閏ran
		this.setLayout(null);
