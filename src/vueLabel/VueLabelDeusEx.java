...
public class VueLabelDeusEx extends JFrame {
	
	public VueLabelDeusEx(Joueur j) throws InterruptedException{
	setSize(600,100);
    setLocation(300, 200);
    setUndecorated(true);
    setVisible(true);
	...
	Label lb=new Label("Le joueur virtuel n°"+j.getNumJoueur()+" utilise une carte DeusEx");
	...
	{
		VueLabelDeusEx alerte = new VueLabelDeusEx(j);
