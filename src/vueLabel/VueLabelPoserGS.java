...
public class VueLabelPoserGS extends JFrame{
	public VueLabelPoserGS(Joueur j) throws InterruptedException{
	setSize(600,100);
    setLocation(300, 200);
    setUndecorated(true);
    setVisible(true);
	...
	Label lb=new Label("Le joueur virtuel n°"+j.getNumJoueur()+" pose un guide spirituel");
	...
	{
		VueLabelPoserGS alerte = new VueLabelPoserGS(j);
