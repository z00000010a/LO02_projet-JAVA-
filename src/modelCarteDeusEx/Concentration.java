 ...
 *@see Concentration.modelCarteDeuxEx#Concentration 
 * 
 * **/
	...
	public Concentration() {
		...
		this.setDescription("Vous r閏up閞ez un des Guides Spirituels pos閟 devant une autre Divinit� "
				+ "et le placez devant vous avec les Croyants qui y sont attach閟.");
		Image image = null;
		try {
			image = ImageIO.read(new File ("concentration.jpg"));
	...
	/**
	 * the capacity:Détruit Vous récupérez un des Guides Spirituels posés 
	 * devant une autre Divinité et le placez devant vous avec les Croyants
	 *  qui y sont attachés.
	 * @param numJ 
